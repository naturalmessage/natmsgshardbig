...
-- This contains function shardsvrdb.scan_shard_delete,
...
-- ----------------------------------------
-- ----------------------------------------
DROP FUNCTION IF EXISTS shardsvrdb.scan_shard_delete();

CREATE FUNCTION shardsvrdb.scan_shard_delete() RETURNS int AS $$
DECLARE
rows_deleted int;
BEGIN
	...
	DELETE FROM shardsvrdb.shards WHERE delete_on_date < current_date;
